...
RSpec.describe Fintecture::Ais::Transactions do
  ...
  it 'GET /transactions' do
    ...
    transactions_response = ais_client.transactions customer_id: customer_id, account_id: account_id, remove_nulls: false, convert_dates: false, filters: nil
  ...
  it 'GET /transactions + optional remove_nulls & convert_dates' do
    ...
    transactions_response = ais_client.transactions customer_id: customer_id, account_id: account_id, remove_nulls: true, convert_dates: true, filters: nil
    transaction = transactions_response['data'].first
