...
RSpec.describe Fintecture::Ais::Accounts do
  ...
  it 'GET /accounts' do
    ...
    accounts_response = ais_client.accounts customer_id: customer_id, account_id: nil, remove_nulls: false, withBalances: false
  ...
  it 'GET /accounts + optional remove_nulls' do
    ...
    accounts_response = ais_client.accounts customer_id: customer_id, account_id: nil, remove_nulls: true, withBalances: nil
    account = accounts_response['data'].first
  ...
  it 'GET /accounts + optional remove_nulls & withBalances' do
    ...
    accounts_response = ais_client.accounts customer_id: customer_id, account_id: nil, remove_nulls: true, withBalances: true
    account = accounts_response['data'].first
  ...
  it 'GET /accounts/[account_id]' do
    ais_client.generate_token code
    accounts_response = ais_client.accounts customer_id: customer_id, account_id: account_id, remove_nulls: nil, withBalances: nil
