...
# connect_response = Fintecture::Pis.get_connect @tokens['access_token'], payment_attrs_connect
# connect_response_body = JSON.parse connect_response.body
# url = connect_response_body['meta']['url']
# puts url

# request_to_pay_response = Fintecture::Pis.request_to_pay @tokens['access_token'], payment_attrs_request_to_pay
# request_to_pay_response_body = JSON.parse request_to_pay_response.body
# puts request_to_pay_response_body

payment_response = Fintecture::Pis.get_payments @tokens['access_token']
payment_response_body = JSON.parse payment_response.body
meta = payment_response_body["meta"]
data = payment_response_body["data"]

found = data.detect {|payment| payment['meta']['session_id'] == 3}
